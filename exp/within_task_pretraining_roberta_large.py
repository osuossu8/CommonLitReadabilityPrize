...
class TrainConfig:
    train_file= 'inputs/mlm_data.csv'
    validation_file = 'inputs/mlm_data.csv'
    validation_split_percentage= 5
    pad_to_max_length= True
    model_name_or_path= 'roberta-large' # 'roberta-base'
    config_name= 'roberta-large' # 'roberta-base'
    tokenizer_name= 'roberta-large' # 'roberta-base'
    use_slow_tokenizer= True
    per_device_train_batch_size= 4 # 8
    per_device_eval_batch_size= 8
    learning_rate= 5e-5
    weight_decay= 0.0
    num_train_epochs= 5 # 1 # change to 5
